...
**Note:** Saving the password into a variable is not recommended from a security point of view. TS variables can be saved in the _smsts.log_ file which can be viewed after the task sequence has finished. 
...
<GuiOption Type="PasswordBox" ExposePassword="TRUE">
    ...
    <NoLoginMessage>Please login</NoLoginMessage>
