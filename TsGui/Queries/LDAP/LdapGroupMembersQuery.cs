...
namespace TsGui.Queries.LDAP
{
    public class LdapGroupMembersQuery : BaseQuery, IAuthenticatorConsumer
    {
        ...
        public LdapGroupMembersQuery(XElement InputXml, ILinkTarget owner) : base(owner)
        {
